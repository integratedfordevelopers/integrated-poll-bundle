...
namespace Integrated\Bundle\PollBundle\DependencyInjection\Compiler;
...
class ThemeManagerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $definition->addMethodCall('registerPath', ['default', '@IntegratedPollBundle/Resources/views/themes/default']);
    }
}
